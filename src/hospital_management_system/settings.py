...
SECRET_KEY = 'django-insecure-e6k4f4=43!#l)hb@flpvnm8mwn_qaoxh0wbp$3@@rr*5xc(mv)'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://127.0.0.1:6379/1',  # Use your Redis server's URL and database number
        'OPTIONS': {
...
MIDDLEWARE = [
    ...
    'debug_toolbar.middleware.DebugToolbarMiddleware',  # Corrected middleware
]
